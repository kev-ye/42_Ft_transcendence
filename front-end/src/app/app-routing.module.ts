...
const routes: Routes = [
  ...
  { path: 'user_login', component: UserLoginComponent, canActivate: [LoginGuard] },
	{ path: 'two_factor', component: TwoFactorComponent, canActivate: [TwoFactorGuard] },
  { path: 'user_subscription', component: UserSubscriptionComponent, canActivate: [SubscriptionGuard] },
